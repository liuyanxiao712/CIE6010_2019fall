...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{upgreek}  %zhipeng add this package
...
\publisher{Course notes: Version 1.06} % Publisher
...
\noindent \= Version 1.06: \ \= Distrivution of rest of chapter 7, including qudratic programs and quadratically-constrained quadratic programs.\\
...
\label{ch.linEqLS}
\input{ch06_linEqLS.tex}

\chapter{Linear programs, quadratic programs, and quadratically-constrainted quadratic programs}
\label{ch.linQuadGeom}
\input{ch07_linQuadGeom.tex}

\chapter{Convexity}
\label{ch.convex}
\input{ch08_convex.tex}
